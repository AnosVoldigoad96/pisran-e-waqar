                            ...
                            {packages.map((pkg) => (
                                <CarouselItem key={pkg.id} className="pl-6 md:basis-1/2 lg:basis-1/3">
                                    <div className="h-full p-1">
                                        <div className="relative flex h-full flex-col justify-between rounded-lg border bg-card text-card-foreground shadow-sm transition-all duration-300 hover:shadow-primary/20 hover:shadow-xl hover:-translate-y-1">
                                            <div className="p-6">
                                            ...
                                            <div className="flex items-end justify-between border-t p-4 pt-4">
                                                <div>
